import { CLEAR_ALERT, DISPLAY_ALERT, REGISTER_USER_BEGIN,REGISTER_USER_SUCESS, REGISTER_USER_ERROR
...
//Register
    if (action.type === REGISTER_USER_BEGIN) {
      ...
      /* This code block is handling the action of toggling the sidebar. If the action type is
      `TOGGLE_SIDEBAR`, it will return a new state object with the `showSidebar` property set to the
      opposite of its current value. This means that if `showSidebar` is currently `true`, it will
